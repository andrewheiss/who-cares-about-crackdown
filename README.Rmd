...
[![OSF DOI](https://img.shields.io/badge/OSF-10.17605%2FOSF.IO%2FSM5EW-blue)](https://doi.org/10.17605/OSF.IO/SM5EW) [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.4064840.svg)](https://doi.org/10.5281/zenodo.4064840)

> `r Authors`. `r Year`. ["`r Title`,"](https://doi.org/10.17605/OSF.IO/SM5EW) 
...
![Preregistered](img/preregistered_large_color.png) &emsp; ![Open data](img/data_large_color.png) &emsp; ![Open](img/materials_large_color.png)
...
4. Make sure you have a working installation of LaTeX:
    - *Easy-and-recommended way*: Install the [**tinytex** package](https://yihui.org/tinytex/) by running `install.packages("tinytex")` in the R console, then run `tinytex::install_tinytex()`
