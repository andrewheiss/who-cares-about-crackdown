...
% The manuscript template uses the setspace package for \doublespacing and 
% \singlespacing, but this template doesn't. If we use \singlespacing anywhere 
% in the document to change spacing (like for tables), this template no longer 
% compiles. So we create empty versions of \singlespacing and \doublespacing 
% here that don't do anything
